...
public class DropTableAnalyzerTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void testDropSystemTable() throws Exception {
        ...
        expectedException.expectMessage("relation \"sys.cluster\" doesn't support or allow DROP operations");
    ...
    public void testDropInformationSchemaTable() throws Exception {
        expectedException.expect(UnsupportedOperationException.class);
        expectedException.expectMessage("relation \"information_schema.tables\" doesn't support or allow DROP operations");
